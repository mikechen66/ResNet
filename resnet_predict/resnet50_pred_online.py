...
$ python resnet50_pred_online.py

Even if adopting the validation_utils of imageNet and change the prediction method in the related 
predict_val.py, the prediction is extremely than the inception v4 model. So we need to improve the 
ResNet training.
