...
def ResNet152(input_shape, num_classes, include_top, weights, 
...
if __name__ == '__main__':
    ...
    im = cv2.resize(cv2.imread('/home/mike/Documents/keras_resnet_v1/images/cat.jpg'), (224, 224)).astype(np.float32)
